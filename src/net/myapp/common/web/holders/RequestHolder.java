...
public class RequestHolder
{
  ...
  private static final ThreadLocal<Map<String, Cookie>> cookieMapHolder = new ThreadLocal<Map<String, Cookie>>();
  
  public RequestHolder() {}
  
  public static HttpServletRequest get() { return (HttpServletRequest)requestHolder.get(); }
